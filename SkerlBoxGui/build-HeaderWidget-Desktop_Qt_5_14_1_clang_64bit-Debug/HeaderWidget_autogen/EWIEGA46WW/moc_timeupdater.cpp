/****************************************************************************
** Meta object code from reading C++ file 'timeupdater.hpp'
**
...
#error "The header file 'timeupdater.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TimeUpdater_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TimeUpdater_t qt_meta_stringdata_TimeUpdater = {
    {
QT_MOC_LITERAL(0, 0, 11), // "TimeUpdater"
QT_MOC_LITERAL(1, 12, 11), // "timeUpdated"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 10), // "timeString"
QT_MOC_LITERAL(4, 36, 9) // "startTime"

    },
    "TimeUpdater\0timeUpdated\0\0timeString\0"
    "startTime"
};
...
void TimeUpdater::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (TimeUpdater::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TimeUpdater::timeUpdated)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject TimeUpdater::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_TimeUpdater.data,
...
// SIGNAL 0
void TimeUpdater::timeUpdated(const QString & _t1)
{
