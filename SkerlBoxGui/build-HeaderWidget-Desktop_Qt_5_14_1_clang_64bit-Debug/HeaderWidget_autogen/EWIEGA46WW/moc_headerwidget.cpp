...
QT_MOC_LITERAL(1, 13, 17), // "updateCurrentTime"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 11), // "currentTime"
QT_MOC_LITERAL(4, 44, 18) // "on_quitBtn_clicked"

    },
    "HeaderWidget\0updateCurrentTime\0\0"
    "currentTime\0on_quitBtn_clicked"
};
...
void HeaderWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateCurrentTime((*reinterpret_cast< const QString(*)>(_a[1]))); break;
...
void *HeaderWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "iDioObserver"))
        return static_cast< iDioObserver*>(this);
